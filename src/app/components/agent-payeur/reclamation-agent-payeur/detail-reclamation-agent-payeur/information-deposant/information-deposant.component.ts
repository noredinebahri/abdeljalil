...
@Component({
  selector: 'app-information-deposant',
  templateUrl: './information-deposant.component.html',
  styleUrl: './information-deposant.component.scss'
})
export class InformationDeposantComponent implements OnInit{
  // TODO: authorities
  showCentreAppele: boolean = false;
