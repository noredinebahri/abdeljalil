...
@Component({
  selector: 'app-detail-reprentants',
  templateUrl: './detail-reprentants.component.html',
  styleUrl: './detail-reprentants.component.scss'
})
export class DetailReprentantsComponent {
