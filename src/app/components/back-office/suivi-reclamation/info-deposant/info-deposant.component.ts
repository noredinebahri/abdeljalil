...
@Component({
  selector: 'app-info-deposant',
  templateUrl: './info-deposant.component.html',
  styleUrl: './info-deposant.component.scss'
})
export class InfoDeposantComponent {

  inforGeneraleForm!: FormItem[];

  coordonneesContactForm: FormItem[] = [
    {
      itemType: 'title',
