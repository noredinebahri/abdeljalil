...
@Component({
  selector: 'app-agent-payeur',
  templateUrl: './agent-payeur.component.html',
  styleUrl: './agent-payeur.component.scss'
})
export class AgentPayeurComponent {
  ...
  filterFields: FilterField[] = [
    ...
    { name: 'ribSGFG', placeholder: 'referentiel.ribSGFG', type: 'text' },
    ...
    if (event.action === 'desactiver' || event.action === 'activer') {
      ...
      if (event.item && (
        ...
        this.formFilter = new FormGroup({
            ...
            ribSGFG: new FormControl(event.item.ribSGFG),
        });
    } else {
